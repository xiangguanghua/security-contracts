...
contract PuppyRaffle is ERC721, Ownable {
    ...
    // notice this entry point of the project
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        // q why need msg.value equal entranceFee * newPlayers.length ?
        // q what is the newPlayers is ?
        // q if the newPlayers is very big array, the are a dos attack.
        // q if the newPlayers is 0 ?
        ...
        // q a lot of gas is used in here
        // @audit DoS
    ...
    function refund(uint256 playerIndex) public {
        // @aduit maybe playerIndex is bad num
