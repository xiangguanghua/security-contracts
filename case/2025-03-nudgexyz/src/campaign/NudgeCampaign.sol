...
contract NudgeCampaign is INudgeCampaign, AccessControl {
   ...
   *       - NudgeCampaign.claimRewards(uint256[]) (src/campaign/NudgeCampaign.sol#260-303)
   *       - NudgeCampaign.distributedRewards (src/campaign/NudgeCampaign.sol#51)
   *       - NudgeCampaign.getCampaignInfo() (src/campaign/NudgeCampaign.sol#445-473)
   *       - participation.status = ParticipationStatus.CLAIMED (src/campaign/NudgeCampaign.sol#296)
   */
