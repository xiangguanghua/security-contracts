...
contract PuppyRaffleTest is Test {
    ...
    // DoS Attact
    function test_DoS_Attact() public {
        ...
        console.log("Gas cost of the first 100 players : ", gasCost);
        ...
        // 计算 gas 消耗和成本
        uint256 gasCostSecond = (gasStartSecond - gasEndSecond) * tx.gasprice; // 计算 gas 成本
        console.log("Gas cost of the Second 100 players: ", gasCostSecond);
